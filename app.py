...
st.write("Workshop Special - Secure Backend Configuration Mode.")
...
# Isse baar-baar key daalne ka jhanjhat aur script error dono permanent khatam!
try:
...
if uploaded_file is not None:
    ...
    if not API_KEY:
        st.error("⚠️ Streamlit Secrets me API Key sahi se save nahi hui hai! Kripya settings check karein.")
    else:
