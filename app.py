...
# =========================================================================
# ⚙️ 1. DEDICATED SASH CALCULATOR (Formula + Input Box Dono!)
# =========================================================================
st.header("⚙️ 1. QUICK SINGLE SASH CALCULATOR")
with st.container():
    # Pehle Formula likhne ka dabba
    ...
    # Ab window ka Height-Width daalne ka dabba (Jo pehle miss ho gaya tha!)
